...
export function StreakCard({ streak = 0, standUpTime }: StreakCardProps) {
  ...
  return (
    <div className="p-6 rounded-xl bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 shadow-sm hover:shadow-md transition-all duration-300 group">
      <div className="relative flex items-center justify-between">
        ...
        <Star className="w-5 h-5 text-primary/60 animate-pulse" />
      </div>
