...
export function HurdlesButton() {
  ...
  if (isError || !hurdles?.length) {
    return (
      <Link 
        to="/hurdles" 
        className="block rounded-xl bg-white shadow-md transition-all hover:shadow-lg border border-orange-100/30 hover:border-orange-200/50"
      >
  ...
  return (
    <Link 
      to="/hurdles" 
      className="block rounded-xl bg-white shadow-md overflow-hidden transition-all hover:shadow-lg border border-orange-100/30 hover:border-orange-200/50"
    >
