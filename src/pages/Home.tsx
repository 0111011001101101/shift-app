    ...
    <PageContainer>
      <div className="space-y-6">
        ...
        <Card className="bg-white/95 backdrop-blur-sm p-4 border border-gray-100/50">
          ...
          <Button variant="secondary" className="w-full text-xs py-2 h-9 bg-pink-500 hover:bg-pink-600 text-white">
        ...
        <section className="space-y-3">
          ...
          <Card className="text-center py-4 px-4">
            <div className="text-2xl font-semibold text-pink-500 mb-1">7</div>
